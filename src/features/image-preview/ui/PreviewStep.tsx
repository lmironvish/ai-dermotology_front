      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <p className="text-[13px]" style={{ color: "#4ade80", fontFamily: "var(--font-body)" }}>
              Формат, размер и качество соответствуют требованиям
            </p>
          </div>
          ...
          >
            ...
            >
              Я соглашаюсь на обработку персональных данных и подтверждаю, что имею право
              загружать это изображение для анализа.
            </span>
          </label>
          ...
          >
            Обработка займет не более 2 минут
          </p>
